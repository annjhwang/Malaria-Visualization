//global variables
var keyArray = ["UN_population","At_risk","At_high_risk","Suspected_malaria_cases","Malaria_cases"];
...
// drawing a map
//var legend_labels[5][7];

// legend_labels[UN_population] = ["< 50", "50+", "150+", "350+", "750+", "> 1500"] 
  ...
  .await(function(error, mapTopJson, malariaDataCsv){
    ...
    var jsonRegions = mapTopJson.objects.collection.geometries;
      ...
      for (var i=0; i< malariaDataCsv.length; i++) { 
        ...
        var csvRegion = malariaDataCsv[i]; //the current region
